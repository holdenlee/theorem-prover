...
--does not show tree index.
showPropOnly :: SymbolLib -> Node -> MathDAG -> String
showPropOnly slib n md = 
  let 
    prop = getProp n md
  in 
    (show n) ++ ": " ++ (show2 slib prop)
